    ...
    <table>
        <tbody>
            ...
            <tr v-if="event.eventLink">
                ...
                <td>
                    <a :href="event.eventLink" target="_blank" rel="noopener noreferrer"> Wydarzenie na Facebooku </a>
                </td>
            </tr>
            <tr v-if="event.type">
                <td class="event-icon">
...
<script setup>
import { getEventTypeNameAndEmoji, formatEventDate } from "../helpers/events";
